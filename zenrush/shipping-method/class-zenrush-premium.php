...
class WC_Zenrush_Premiumversand extends WC_Shipping_Method
{
     ...
     */
    private string $rates_url = 'https://zenrush.zenfulfillment.com/api/zenrush/rates?zenrushType=premium';
    ...
    public function is_enabled() {
        ...
        if ( false === $cached_status ) {
            ...
            return $status['zenrush'];
        }
    
        // Return cached status
        return $cached_status['zenrush'];
    }
}
